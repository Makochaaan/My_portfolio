...
return (
        <main className="flex flex-col items-center px-60">
            ...
            <div className="mt-20 flex-col min-h-screen">
                ...
                <h1 className="mt-10 flex justify-center">Yorimichizu</h1>
                <div className="flex justify-center my-10">
                    <a href="https://yorimichizu.up.railway.app" target="_blank" rel="noopener noreferrer" className="bg-indigo-600 text-white rounded-md px-4 py-2">クリックして触ってみる→</a>
                </div>
