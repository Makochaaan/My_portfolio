            ...
            <div className="divide-y divide-blue-400">
                <div className="mt-80 mb-20 z-10 flex place-items-center relative">
                    ...
                    <div className="flex-col ml-12 text-center">
                        ...
                        <p className="mb-8">{process.env.BELONG}</p>
                        <p className="mb-16">音楽と旅と食事を愛するアプリ開発者です。</p>
                        <NextLink href="../about" className="bg-gray-300 hover:bg-gray-200 rounded-xl p-5 text-blue-800 font-bold hover:text-blue-400 hover:duration-500 border border-blue-800 hover:border-blue-400">もっと見る →</NextLink>
                    </div>
                </div>
                ...
                <div className="pt-20 mb-20 flex flex-col items-center">
                    ...
                    <div className="flex flex-col items-center">
                        <button className="mt-10 bg-gray-300 hover:bg-gray-400 hover:duration-500 text-gray-800 font-bold py-5 px-40 w-full inline-flex items-center rounded-full">
                        <img className="fill-current w-7 h-6 mr-2" src="/LI-In-mark.png" alt="LinkedIn Logo" />
                            <span>LinkedIn</span>
                        </button><br></br>
                        <button className="mt-2 bg-gray-300 hover:bg-gray-400 hover:duration-500 text-gray-800 font-bold py-5 px-40 w-full rounded-full inline-flex items-center">
                            <img className="fill-current w-6 h-6 mr-2" src="/github-mark.svg" alt="Github Logo" />
                            <span>Github</span>
                        </button><br></br>
                        <button className="mt-2 bg-gray-300 hover:bg-gray-400 hover:duration-500 text-gray-800 font-bold py-5 px-40 w-full rounded-full inline-flex items-center">
                        <img className="fill-current w-6 h-6 mr-2" src="/Instagram_mark.svg" alt="Github Logo" />
                            <span>Instagram</span>
                        </button><br></br>
                    </div>
                </div>
