    ...
    <main className="flex flex-col items-center px-60">
      ...
      <div className="z-10 w-full max-w-5xl items-center font-medium lg:flex-col">
            ...
            <FadeinAnimation>
              <div className="mt-20 z-10 flex place-items-center relative">
                ...
                <div className="flex-col ml-12 text-center">
                    ...
                    <p className="text-xl mb-8">{process.env.NEXT_PUBLIC_BIRTHDAY}, 愛知県生まれ</p>
                    <p className="text-xl mb-4">{process.env.NEXT_PUBLIC_BELONG}</p>
        ...
        <div className="mt-10 flex-col place-items-center ">
            ...
            <p >　本ポートフォリオをご覧いただきありがとうございます。{process.env.NEXT_PUBLIC_NAME}({process.env.NEXT_PUBLIC_NAME_KANA})と申します。名古屋大学 情報学部コンピュータ科学科 知能システム学専攻所属の3年生です。専攻先では、エレキギターやその音を加工するエフェクターといったものの出力する音声を扱う、音声信号処理という分野に興味を持っています。</p>
        ...
        <p className="my-4 text-md">　ご連絡等ございましたら、以下のリンク先又はメール( {process.env.NEXT_PUBLIC_MAIL} )よりご連絡ください。</p>
