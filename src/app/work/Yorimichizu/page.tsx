        ...
        <main className="flex flex-col items-center px-60">
            <Header page="work"/>
                ...
                <div className="mt-20 flex-col place-items-center ">
                    <h1 className="flex justify-center my-10 text-4xl">普段の道をより面白く...</h1>
                    ...
                    <h2 className="flex justify-center my-10 text-4xl">使い方</h2>
                    ...
                    <h2 className="flex justify-center my-10 text-4xl">ポイント</h2>
