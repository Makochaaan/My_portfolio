                ...
                <div className="divide-y divide-blue-400">
                    <div className="mt-80 mb-20 z-10 flex place-items-center relative">
                        ...
                        <div className="flex-col ml-12 text-center animate-slide-from-right">
                            <h2 className="text-center font-bold text-xl">Eu sou...</h2>
                            <h1 className="font-extrabold mb-8 text-5xl text-blue-800">{process.env.NEXT_PUBLIC_NAME}</h1>
                            {/* <p className="text-16 mb-8">{process.env.NEXT_PUBLIC_NAME}</p> */}
                            <p className="mb-8">{process.env.NEXT_PUBLIC_BELONG_PT}</p>
                            <p className="mb-16"></p>
                            <NextLink href="../about" className="bg-gray-300 hover:bg-gray-200 rounded-xl p-5 text-blue-800 font-bold hover:text-blue-400 hover:duration-500 border border-blue-800 hover:border-blue-400">Sobre Mim→</NextLink>
                        </div>
                        </SlideAnimationRight>
                    </div>
                    ...
                    <div className="pt-20 mb-20 flex-col">
                        ...
                        <div className="flex justify-center">
                            <NextLink href="../work" className="bg-indigo-600 text-white rounded-md px-4 py-2">Assista Mais →</NextLink>
                        </div>
                    </div>
                    <div className="pt-20 mb-20 flex flex-col items-center">
                        <h1 className="mb-10 font-bold text-3xl">CONTACTOS</h1>
